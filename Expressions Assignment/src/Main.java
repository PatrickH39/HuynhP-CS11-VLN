public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(10 + 4/3); // if you were to do this on a calculator, it would return 1.3 repeating; however in Java, it would return 1.
        System.out.println(10 + 1);
        System.out.println(11);

        //Expression 2
        System.out.println(23%4 + (18 - 3 / 2));
        System.out.println(3 + (18 - 3 / 2)); // again, like on expression 1, 3/2 returns 1.
        ...
        System.out.println(((3) + 81d/5)); // Changed integer to double so that it returns 16.2.
